...
--
-- Host: 127.0.0.1
-- SQLINES DEMO *** Jun 13, 2023 at 06:32 PM
-- SQLINES DEMO *** 0.4.27-MariaDB
-- PHP Version: 8.2.0
...
--
-- SQLINES DEMO *** or table `admin_permissions`
--
...
CREATE TABLE admin_permissions (
  ...
  properties text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(properties)),
  conditions text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(conditions)),
  created_at timestamp(6) DEFAULT NULL,
  updated_at timestamp(6) DEFAULT NULL,
  created_by_id int CHECK (created_by_id > 0) DEFAULT NULL,
  updated_by_id int CHECK (updated_by_id > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `admin_permissions`
--
...
--
-- SQLINES DEMO *** or table `admin_permissions_role_links`
--

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE admin_permissions_role_links (
  id int CHECK (id > 0) NOT NULL,
  permission_id int CHECK (permission_id > 0) DEFAULT NULL,
  role_id int CHECK (role_id > 0) DEFAULT NULL,
  permission_order double precision CHECK (permission_order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `admin_permissions_role_links`
--
...
--
-- SQLINES DEMO *** or table `admin_roles`
--
...
--
-- SQLINES DEMO *** table `admin_roles`
--
...
--
-- SQLINES DEMO *** or table `admin_users_roles_links`
--
...
CREATE TABLE admin_users_roles_links (
  ...
  role_id int CHECK (role_id > 0) DEFAULT NULL,
  role_order double precision CHECK (role_order > 0) DEFAULT NULL,
  user_order double precision CHECK (user_order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `admin_users_roles_links`
--
...
CREATE TABLE files (
  ...
  formats text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(formats)),
  ...
  provider_metadata text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(provider_metadata)),
...
--
-- SQLINES DEMO *** or table `files_folder_links`
--

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE files_folder_links (
  id int CHECK (id > 0) NOT NULL,
  file_id int CHECK (file_id > 0) DEFAULT NULL,
  folder_id int CHECK (folder_id > 0) DEFAULT NULL,
  file_order double precision CHECK (file_order > 0) DEFAULT NULL
) ;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** or table `files_related_morphs`
--
...
CREATE TABLE files_related_morphs (
  id int CHECK (id > 0) NOT NULL,
  file_id int CHECK (file_id > 0) DEFAULT NULL,
  related_id int CHECK (related_id > 0) DEFAULT NULL,
  related_type varchar(255) DEFAULT NULL,
  field varchar(255) DEFAULT NULL,
  order double precision CHECK (order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `files_related_morphs`
--
...
--
-- SQLINES DEMO *** or table `i18n_locale`
--
...
--
-- SQLINES DEMO *** table `i18n_locale`
--
...
(20, 'Apple Watch SE Gold', 'The Apple Watch SE Gold is a versatile smartwatch that combines style and functionality. It features a gold aluminum finish that adds a touch of elegance to your wrist. The watch is equipped with a Retina LTPO OLED display, offering a bright and clear view of your data and apps.nnThe Apple Watch SE Gold is powered by the S5 SiP with a 64-bit dual-core processor, ensuring smooth performance and quick response times. It comes with a capacity of 32GB, providing ample space for your apps and data.nnThe watch includes a range of health and fitness features, such as a second-generation optical heart sensor, an always-on altimeter, and emergency SOS. It's also water-resistant up to 50 meters, making it suitable for shallow-water activities like swimming in a pool or ocean.nnThe Apple Watch SE Gold supports both GPS and cellular connectivity, allowing you to stay connected even without your iPhone nearby. It also supports Apple Pay and GymKit, offering convenience for your workouts and payments.nnThe watch comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a built-in rechargeable lithium-ion battery that offers up to 18 hours of use, ensuring it can keep up -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with your busy lifestyle. It charges via a USB-C magnetic charging cable.', '299.99', 0, '2023-06-08 21:37:42.688000', '2023-06-08 21:41:35.859000', '2023-06-08 21:37:43.703000', 1, 1, 'trending'),
(21, 'Versace Versus', 'The Versace Versus Black watch from the Domus Collection is a stylish and bold timepiece that embodies the spirit of Versace's Versus line. This watch features a large 44mm case diameter with an artistic watch face and prominent Versus Versace logo representation, making it a standout piece in any watch collection.nnThe watch comes with an adjustable black silicone strap, offering comfort and durability. The black dial and gunmetal details add to the sleek and modern aesthetic of the watch, making it a perfect accessory for both casual and formal occasions.nnThe Versace Versus Black watch is water-resistant up to 50 meters, making it capable of withstanding light splashes and brief immersion in water, though it is not suitable for swimming, diving, or prolonged water exposure.nnThe Domus Collection was created to match your watches with your everyday fashion, and the Versus Versace Black watch is no exception. It's packed in a solid branded giftable box, making it an ideal gift for watch enthusiasts.', '214.00', 0, '2023-06-08 21:44:58.872000', '2023-06-08 21:44:59.749000', '2023-06-08 21:44:59.745000', 1, 1, 'featured'),
(22, 'Adidas Digital Two ', 'The Adidas Digital Two watch is a modern and stylish timepiece that combines functionality -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with the iconic Adidas aesthetic. This watch features a digital dial -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a light-up feature, ensuring visibility even in low-light conditions.nnThe watch is housed in a 36mm brushed gold-tone stainless steel case, adding a touch of elegance to the sporty design. The bracelet is also made of brushed gold-tone stainless steel, providing durability and a cohesive look. The Adidas logo is prominently displayed on the back case and buckle, showcasing the brand's identity.nnThe Digital Two watch comes with a range of functions, including hours, minutes, seconds, date, alarm, stopwatch, and countdown timer, making it a versatile accessory for everyday wear.nnThe watch is water-resistant up to 50 meters, making it suitable for light water activities but not for diving or snorkeling.', '77.89', 0, '2023-06-08 21:48:04.434000', '2023-06-08 21:56:48.024000', '2023-06-08 21:48:05.389000', 1, 1, 'normal'),
...
(24, 'Disney Mickey Mouse', 'The Disney Mickey Mouse Watch for Kids is a fun and educational accessory that your child will love. This watch features a vibrant design with Mickey Mouse characters that will delight any Disney fan.nnThe watch comes with a variety of kid-friendly features. It includes a selfie camera for taking pictures, a photo album viewer, a video player, a voice recorder, a calculator, an alarm clock, a pedometer step counter, various playable games, and changeable watch faces.nnDesigned with a red and black color scheme, this watch has a 40mm screen size and a square shape that's easy for kids to read. It's also compatible with smartphones, making it a versatile accessory for your child.nnThe watch is powered by a long-lasting rechargeable battery, eliminating the need for frequent battery replacements. It comes with a USB charging cable for your convenience.', '14.99', 0, '2023-06-08 21:55:49.279000', '2023-06-08 21:56:13.766000', '2023-06-08 21:55:50.980000', 1, 1, 'normal'),
(25, 'Michael Kors Liliane', 'The Michael Kors LILIANE SET is a luxurious and elegant accessory set that includes a watch and a bracelet. The watch features a three-hand movement housed in a 36mm rose gold-tone stainless steel case. The dial is a beautiful shade of pink, adding a touch of femininity to the piece.nnThe watch strap, made of stainless steel, is also in a rose gold tone, matching the case and creating a cohesive and stylish look. The strap is 16mm wide and closes with a bracelet deployant closure, ensuring a secure fit.nnThe set also includes a matching rose gold-tone stainless steel bracelet with a slider closure. This bracelet adds an extra touch of sophistication to the set, making it a perfect gift for someone special or a treat for yourself.nnThe watch is water-resistant up to 5 ATM, making it suitable for short periods of recreational swimming, but not diving or snorkeling.', '174.95', 0, '2023-06-08 21:59:15.064000', '2023-06-12 19:55:56.269000', '2023-06-08 21:59:16.345000', 1, 1, 'trending'),
(26, 'Apple Watch Series 7', 'The Apple Watch Series 7 is a cutting-edge smartwatch that combines style, functionality, and health-focused features. This watch features a larger Always-On Retina LTPO OLED display, offering a clear and bright view even under sunlight. It is powered by the S7 with a 64-bit dual-core processor, ensuring smooth performance and quick app launches.nnThe watch supports LTE and UMTS, Wi-Fi, and Bluetooth connectivity, allowing you to stay connected even without your iPhone nearby. It includes a range of health features such as a blood oxygen sensor, an electrical heart sensor (ECG app), and a third-generation optical heart sensor.nnWith a storage capacity of 32GB, you can store your favorite apps, music, podcasts, and more. The watch offers up to 18 hours of battery life and comes with a USB-C magnetic fast charging cable. It is water-resistant up to 50 meters, making it suitable for shallow-water activities like swimming.nnDesigned with environmental considerations, the watch is made with 100% recycled aluminum in the case and 100% recycled tungsten in the Taptic Engine. The Apple Watch Series 7 is a perfect blend of style, functionality, and health-focused features, making it a great accessory for any lifestyle.', '425.79', 0, '2023-06-08 22:01:16.690000', '2023-06-12 20:14:55.227000', '2023-06-08 22:01:54.661000', 1, 1, 'normal'),
(27, 'Lacoste', 'The Lacoste Kids Watch is a vibrant and playful timepiece designed for children. This watch features a blue dial and a blue silicone strap, making it a fun and colorful accessory for your child.nnThe watch has a plastic case with a diameter of 32mm, making it a suitable size for children's wrists. The dial includes Arabic numerals, making it easy for kids to read the time.nnThe Lacoste Kids Watch is water-resistant up to 5 ATM, meaning it can withstand splashes or brief immersion in water, but it is not suitable for swimming or bathing.nnThe watch is powered by a quartz movement, ensuring accurate timekeeping. The silicone strap is durable and comfortable for everyday wear, and it comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a buckle clasp for secure fastening.', '69.95', 1, '2023-06-08 22:04:01.015000', '2023-06-08 22:04:01.876000', '2023-06-08 22:04:01.873000', 1, 1, 'normal'),
(28, 'Swiss Alpine Military', 'The Swiss Alpine Military Watch is a robust and stylish timepiece designed for men who appreciate precision and durability. This watch features a 43mm stainless steel case with a matted, polished surface, giving it a striking appearance. The dial is black, -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with illuminated indexes and hands for easy readability even in low light conditions.nnThe watch is powered by a quartz movement, ensuring accurate timekeeping. It comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a chronograph -- SQLINES LICENSE FOR EVALUATION USE ONLY
create  function, adding to its utility. The watch is water-resistant up to 10 ATM, making it suitable for recreational swimming and snorkeling.nnThe Swiss Alpine Military Watch is fitted -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a real leather strap, providing comfort and durability. Its design is a perfect blend of elegance and functionality, making it an ideal accessory for both casual and formal occasions.', '645.89', 0, '2023-06-08 22:07:12.708000', '2023-06-12 19:55:02.676000', '2023-06-08 22:07:13.693000', 1, 1, 'featured'),
(29, 'Michael Kors Runway', 'The Michael Kors Slim Runway Watch is a sleek and sophisticated timepiece that embodies the brand's signature style. This watch features a minimalist design with a 44mm case size, making it a standout piece in any watch collection.nnThe watch comes with a stainless steel bracelet with a brushed and polished finish, offering both comfort and durability. The round sunray dial adds to the sleek aesthetic of the watch, making it a perfect accessory for both casual and formal occasions.nnThe Slim Runway Watch is water-resistant up to 50m (165ft), making it suitable for short periods of recreational swimming, but not diving or snorkeling. It's powered by a quartz movement, ensuring accurate timekeeping.nnMichael Kors is a world-renowned, award-winning designer of luxury accessories and ready-to-wear -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with an innate sense of glamour and an unfailing eye for timeless chic. The Slim Runway Watch is a testament to this, offering luxurious style -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a modern splash of trend-right touches.', '249.00', 1, '2023-06-08 22:09:59.188000', '2023-06-12 14:25:49.373000', '2023-06-08 22:10:00.171000', 1, 1, 'trending'),
(30, 'Fossil Gen 6', 'The Fossil Gen 6 is a sophisticated smartwatch that combines style, functionality, and advanced health tracking features. This watch features a 1.28-inch AMOLED touchscreen display housed in a 44mm stainless steel casing, offering a clear and bright view for easy navigation.nnThe watch is powered by the Qualcomm Snapdragon Wear 4100+ chipset, ensuring smooth performance and quick app launches. It comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with 1GB of RAM and 8GB of storage, allowing you to store your favorite apps and music.nnThe Gen 6 includes a range of health features such as continuous heart rate monitoring, blood oxygen level measurement, automatic workout detection, and cardio fitness estimations using VO2 Max. It also supports offline Spotify playback for Spotify Premium subscribers.nnThe watch offers Bluetooth 5.0 LE, WiFi, GPS, and NFC connectivity, allowing you to stay connected and make contactless payments -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with Google Pay. It is swim-proof up to 3ATM, making it suitable for shallow-water activities.nnThe Fossil Gen 6 runs on Wear OS 2 and is upgradable to Wear OS 3, offering improved third-party app support and enhanced health tracking features. It charges up to 80% in just 30 minutes, ensuring you're always ready to go.', '239.79', 0, '2023-06-08 22:13:11.115000', '2023-06-12 20:08:07.114000', '2023-06-08 22:13:12.075000', 1, 1, 'featured'),
(31, 'Fossil Gen 6', 'The Fossil Gen 6 is a sophisticated smartwatch that combines style, functionality, and advanced health tracking features. This watch features a 1.28-inch AMOLED touchscreen display housed in a 44mm stainless steel casing, offering a clear and bright view for easy navigation.nnThe watch is powered by the Qualcomm Snapdragon Wear 4100+ chipset, ensuring smooth performance and quick app launches. It comes with 1GB of RAM and 8GB of storage, allowing you to store your favorite apps and music.nnThe Gen 6 includes a range of health features such as continuous heart rate monitoring, blood oxygen level measurement, automatic workout detection, and cardio fitness estimations using VO2 Max. It also supports offline Spotify playback for Spotify Premium subscribers.nnThe watch offers Bluetooth 5.0 LE, WiFi, GPS, and NFC connectivity, allowing you to stay connected and make contactless payments with Google Pay. It is swim-proof up to 3ATM, making it suitable for shallow-water activities.nnThe Fossil Gen 6 runs on Wear OS 2 and is upgradable to Wear OS 3, offering improved third-party app support and enhanced health tracking features. It charges up to 80% in just 30 minutes, ensuring you're always ready to go.', '240.89', 0, '2023-06-08 22:15:18.676000', '2023-06-08 22:15:33.092000', '2023-06-08 22:15:19.522000', 1, 1, 'trending'),
(32, 'U.S. Polo Assn.', 'The U.S. Polo Assn. Watch is a stylish and versatile timepiece that embodies the brand's classic American style. This watch features a sleek design that is suitable for both casual and formal occasions.nnThe watch comes with a durable strap and a round dial, offering a comfortable fit and easy readability. The dial includes hour markers and hands that add to the aesthetic appeal of the watch.nnThe U.S. Polo Assn. Watch is water-resistant, making it suitable for everyday use. It's powered by a quartz movement, ensuring accurate timekeeping.nnU.S Polo Assn. is the official brand of the United States Polo Association (USPA), the governing body for the sport of polo in the U.S. since 1890. The U.S. Polo Assn. brand captures the authenticity of the sport while reflecting loop its rich history and staying true to its roots in classic American style.', '54.99', 1, '2023-06-08 22:19:41.830000', '2023-06-08 22:19:43.064000', '2023-06-08 22:19:43.061000', 1, 1, 'trending'),
(33, 'Disney Frozen', 'The Disney Frozen Child's Watch is a delightful timepiece that brings the magic of Disney's Frozen to your child's wrist. This watch features beloved characters Elsa and Anna on the dial, surrounded by a pink notched bezel. It's designed -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with an easy-to-read dial that has labeled "HOUR" and "MINUTE" hands and a minute track to help children learn to tell time.nnThe watch is made -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with high-quality materials, including a durable plastic case and a comfortable nylon strap. It's also water-resistant up to 30 meters, making it safe to wear in the rain or when splashed.nnThe Disney Frozen Child's Watch comes in a gift-ready box featuring the official Disney Frozen logo, making it a perfect gift for birthdays, holidays, or any special occasion. Please note that the watch is not recommended for bathing, swimming, or diving.', '18.89', 0, '2023-06-08 22:21:25.058000', '2023-06-08 22:21:26.068000', '2023-06-08 22:21:26.062000', 1, 1, 'normal'),
(34, 'Armani Exchange', 'The Armani Exchange Watch is a sophisticated and stylish timepiece that reflects the brand's commitment to quality and design. This watch features a 44mm case diameter, making it a standout piece in any watch collection.nnThe watch comes with a silicone strap, offering both comfort and durability. The dial is brown, adding to the sleek aesthetic of the watch. It includes a three-hand date feature, ensuring you always stay on top of your schedule.nnThe Armani Exchange Watch is water-resistant up to 5 ATM, making it suitable for short periods of recreational swimming, but not diving or snorkeling. It's powered by a quartz movement, ensuring accurate timekeeping.nnArmani Exchange is a brand known for its provocative ads and street-chic lifestyle, inspired by contemporary dance music. This watch embodies the brand's attitude, style, performance, and quality, making it a perfect accessory for any occasion.', '167.00', 0, '2023-06-08 22:23:19.968000', '2023-06-12 19:53:50.757000', '2023-06-08 22:23:20.991000', 1, 1, 'featured'),
(35, 'Michael Kors Lexington', 'The Michael Kors Lexington Watch is a luxurious and stylish timepiece that reflects the brand's commitment to quality and design. This watch features a 44mm case diameter, making it a standout piece in any watch collection.nnThe watch comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a two-tone stainless steel strap, offering both comfort and durability. The dial is silver, adding to the sleek aesthetic of the watch. It includes a three-hand date feature and a chronograph, ensuring you always stay on top of your schedule.nnThe Lexington Watch is water-resistant up to 100m, making it suitable for bathing, swimming, or snorkeling, but not diving. It's powered by a Miyota JS25 Chronograph quartz movement, ensuring accurate timekeeping.nnMichael Kors is a world-renowned, award-winning designer of luxury accessories and ready-to-wear with an innate sense of glamour and an unfailing eye for timeless chic. The Lexington Watch embodies the brand's attitude, style, performance, and quality, making it a perfect accessory for any occasion.', '169.89', 0, '2023-06-08 22:26:09.289000', '2023-06-08 22:26:10.176000', '2023-06-08 22:26:10.172000', 1, 1, 'featured'),
(36, 'Adidas Originals', 'The Adidas Originals EDITION THREE UNISEX Watch is a trendy and versatile timepiece that reflects the brand's commitment to quality and design. This watch features a 42mm case diameter, making it a standout piece in any watch collection.nnThe watch comes with a stainless steel strap, offering both comfort and durability. The dial is green, adding to the sleek aesthetic of the watch. It includes luminescent hands, ensuring you always stay on top of your schedule even in low light conditions.nnThe EDITION THREE UNISEX Watch is water-resistant up to 5 ATM, making it suitable for short periods of recreational swimming, but not diving or snorkeling. It's powered by a quartz movement, ensuring accurate timekeeping.nnAdidas Originals is a brand known for its sports-inspired lifestyle, celebrating originality in a globally trendsetting way. This watch embodies the brand's attitude, style, performance, and quality, making it a perfect accessory for any occasion.', '112.95', 0, '2023-06-08 22:30:06.485000', '2023-06-08 22:30:10.840000', '2023-06-08 22:30:10.835000', 1, 1, 'trending'),
(37, 'Fossil Bannon', 'The Fossil Bannon Watch is a versatile and stylish timepiece that reflects the brand's commitment to quality and design. This watch features a 45mm case diameter, making it a standout piece in any watch collection.nnThe watch comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a stainless steel strap, offering both comfort and durability. The dial is green, adding to the sleek aesthetic of the watch. It includes a multifunction movement, ensuring you always stay on top of your schedule.nnThe Bannon Watch is water-resistant up to 5 ATM, making it suitable for short periods of recreational swimming, but not diving or snorkeling. It's powered by a SR927SW battery, ensuring accurate timekeeping.nnFossil is a brand known for its vintage-inspired designs and high-quality materials. This watch embodies the brand's attitude, style, performance, and quality, making it a perfect accessory for any occasion.', '189.00', 0, '2023-06-08 22:32:11.780000', '2023-06-08 22:32:12.593000', '2023-06-08 22:32:12.590000', 1, 1, 'featured'),
(38, 'Head Paris', 'The HEAD Paris/Moscow Watch is a versatile and high-tech smartwatch that offers a wide range of features to support your active lifestyle. This unisex watch features a 47mm metal case with a mineral lens, making it a standout piece in any watch collection.nnThe watch comes -- SQLINES LICENSE FOR EVALUATION USE ONLY
 with a yellow silicon strap, offering both comfort and durability. The dial is digital, adding to the modern aesthetic of the watch. It includes a multi-sport mode, music and camera remote control, notifications, body temperature measurement, sleep tracker, movement and drink water reminder, alarm clock, step tracker, and heart rate, ECG, blood oxygen, and pressure monitoring.nnThe Paris/Moscow Watch is waterproof up to IP67, making it suitable for short periods of immersion in water, but not diving or snorkeling. It's compatible with Android 4.4 and higher, iOS 8 or later, ensuring you can connect it to your smartphone for enhanced features.nnThe watch has a battery duration of 5 days in normal use and 14 days in standby mode. It comes with the HEAD WATCHES APP, providing a comprehensive overview of your fitness level.', '119.90', 0, '2023-06-08 22:33:50.090000', '2023-06-08 22:33:52.181000', '2023-06-08 22:33:52.176000', 1, 1, 'trending'),
(39, 'Emporio Armani ', 'The Emporio Armani Ladies AR80023 Watch is an elegant and stylish timepiece that reflects the brand's commitment to quality and design. This watch features a 32mm case diameter, making it a perfect fit for a woman's wrist.nnThe watch comes with a silver stainless steel strap, offering both comfort and durability. The dial is white, adding to the sleek aesthetic of the watch. It includes a two-hand movement, ensuring you always stay on top of your schedule.nnThe AR80023 Watch is water-resistant up to 3 ATM, making it suitable for short periods of recreational swimming, but not diving or snorkeling. It's powered by a SR616SW battery, ensuring accurate timekeeping.nnEmporio Armani is a brand known for its modern and sleek designs. This watch embodies the brand's attitude, style, performance, and quality, making it a perfect accessory for any occasion.', '207.00', 0, '2023-06-08 22:36:54.398000', '2023-06-12 20:31:32.521000', '2023-06-08 22:36:55.258000', 1, 1, 'trending'),
...
CREATE TABLE products_categories_links (
  ...
  category_order double precision CHECK (category_order > 0) DEFAULT NULL,
  product_order double precision CHECK (product_order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `products_categories_links`
--
...
--
-- SQLINES DEMO *** or table `products_sub_categories_links`
--
...
CREATE TABLE products_sub_categories_links (
  ...
  product_id int CHECK (product_id > 0) DEFAULT NULL,
  product_order double precision CHECK (product_order > 0) DEFAULT NULL,
  sub_category_id int CHECK (sub_category_id > 0) DEFAULT NULL,
  sub_category_order double precision CHECK (sub_category_order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `products_sub_categories_links`
--
...
--
-- SQLINES DEMO *** or table `strapi_api_tokens`
--
...
--
-- SQLINES DEMO *** table `strapi_api_tokens`
--
...
(1, 'myApi', '', 'custom', '36ef19e03c2d6f360e7b5a7be68c8553f2aaa32564797bc7b7a480e99e65ed16eba1d44ccf65f544f43056647010ea6d71017a101b8e15053324ad8782c387a7', '2023-06-13 16:30:29.689000', NULL, NULL, '2023-06-03 20:50:49.451000', '2023-06-13 16:30:29.689000', NULL, NULL);

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** or table `strapi_api_token_permissions`
--
...
--
-- SQLINES DEMO *** table `strapi_api_token_permissions`
--
...
--
-- SQLINES DEMO *** or table `strapi_api_token_permissions_token_links`
--

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE strapi_api_token_permissions_token_links (
  id int CHECK (id > 0) NOT NULL,
  api_token_permission_id int CHECK (api_token_permission_id > 0) DEFAULT NULL,
  api_token_id int CHECK (api_token_id > 0) DEFAULT NULL,
  api_token_permission_order double precision CHECK (api_token_permission_order > 0) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `strapi_api_token_permissions_token_links`
--
...
--
-- SQLINES DEMO *** or table `strapi_core_store_settings`
--
...
--
-- SQLINES DEMO *** table `strapi_core_store_settings`
--
...
(19, 'plugin_users-permissions_email', '{"reset_password":{"display":"Email.template.reset_password","icon":"sync","options":{"from":{"name":"Administration Panel","email":"no-reply@strapi.io"},"response_email":"","object":"Reset password","message":"<p>We heard that you lost your password. Sorry about that!</p>nn<p>But don’t worry! You can use the following link to reset your password:</p>n<p><%= URL %>?code=<%= TOKEN %></p>nn<p>Thanks.</p>"}},"email_confirmation":{"display":"Email.template.email_confirmation","icon":"check-square","options":{"from":{"name":"Administration Panel","email":"no-reply@strapi.io"},"response_email":"","object":"Account confirmation","message":"<p>Thank you for registering!</p>nn<p>You have to confirm your email address. Please click on the link below.</p>nn<p><%= URL %>?confirmation=<%= CODE %></p>nn<p>Thanks.</p>"}}}', 'object', NULL, NULL),
...
--
-- SQLINES DEMO *** or table `strapi_database_schema`
--

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE strapi_database_schema (
  id int CHECK (id > 0) NOT NULL,
  schema text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(schema)),
  time timestamp(0) DEFAULT NULL,
  hash varchar(255) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `strapi_database_schema`
--
...
--
-- SQLINES DEMO *** or table `strapi_migrations`
--
...
--
-- SQLINES DEMO *** or table `strapi_transfer_tokens`
--
...
--
-- SQLINES DEMO *** or table `strapi_transfer_token_permissions`
--
...
--
-- SQLINES DEMO *** or table `strapi_transfer_token_permissions_token_links`
--

-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE strapi_transfer_token_permissions_token_links (
  id int CHECK (id > 0) NOT NULL,
  transfer_token_permission_id int CHECK (transfer_token_permission_id > 0) DEFAULT NULL,
  transfer_token_id int CHECK (transfer_token_id > 0) DEFAULT NULL,
  transfer_token_permission_order double precision CHECK (transfer_token_permission_order > 0) DEFAULT NULL
) ;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** or table `strapi_webhooks`
--
...
CREATE TABLE strapi_webhooks (
  ...
  headers text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(headers)),
  events text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(events)),
...
--
-- SQLINES DEMO *** or table `sub_categories`
--
...
--
-- SQLINES DEMO *** table `sub_categories`
--
...
--
-- SQLINES DEMO *** or table `sub_categories_categories_links`
--
...
--
-- SQLINES DEMO *** table `sub_categories_categories_links`
--
...
--
-- SQLINES DEMO *** or table `upload_folders`
--
...
--
-- SQLINES DEMO *** or table `upload_folders_parent_links`
--
...
CREATE TABLE upload_folders_parent_links (
  id int CHECK (id > 0) NOT NULL,
  folder_id int CHECK (folder_id > 0) DEFAULT NULL,
  inv_folder_id int CHECK (inv_folder_id > 0) DEFAULT NULL,
  folder_order double precision CHECK (folder_order > 0) DEFAULT NULL
) ;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** or table `up_permissions`
--
...
--
-- SQLINES DEMO *** table `up_permissions`
--
...
--
-- SQLINES DEMO *** or table `up_permissions_role_links`
--
...
--
-- SQLINES DEMO *** table `up_permissions_role_links`
--
...
--
-- SQLINES DEMO *** or table `up_roles`
--
...
--
-- SQLINES DEMO *** or table `up_users`
--
...
--
-- SQLINES DEMO *** or table `up_users_role_links`
--
...
--
-- SQLINES DEMO ***  `admin_permissions`
--
...
--
-- SQLINES DEMO ***  `admin_permissions_role_links`
--
...
--
-- SQLINES DEMO ***  `admin_users_roles_links`
--
...
--
-- SQLINES DEMO ***  `files_folder_links`
--
...
--
-- SQLINES DEMO ***  `files_related_morphs`
--
...
--
-- SQLINES DEMO ***  `products_categories_links`
--
...
--
-- SQLINES DEMO ***  `products_sub_categories_links`
--
...
--
-- SQLINES DEMO ***  `strapi_api_tokens`
--
...
--
-- SQLINES DEMO ***  `strapi_api_token_permissions`
--
...
--
-- SQLINES DEMO ***  `strapi_api_token_permissions_token_links`
--
...
--
-- SQLINES DEMO ***  `strapi_core_store_settings`
--
ALTER TABLE strapi_core_store_settings
  ADD PRIMARY KEY (id);

--
-- SQLINES DEMO ***  `strapi_database_schema`
--
ALTER TABLE strapi_database_schema
  ADD PRIMARY KEY (id);

--
-- SQLINES DEMO ***  `strapi_migrations`
--
ALTER TABLE strapi_migrations
  ADD PRIMARY KEY (id);

--
-- SQLINES DEMO ***  `strapi_transfer_tokens`
--
...
--
-- SQLINES DEMO ***  `strapi_transfer_token_permissions`
--
...
--
-- SQLINES DEMO ***  `strapi_transfer_token_permissions_token_links`
--
...
--
-- SQLINES DEMO ***  `strapi_webhooks`
--
ALTER TABLE strapi_webhooks
  ADD PRIMARY KEY (id);

--
-- SQLINES DEMO ***  `sub_categories`
--
...
--
-- SQLINES DEMO ***  `sub_categories_categories_links`
--
...
--
-- SQLINES DEMO ***  `upload_folders_parent_links`
--
...
--
-- SQLINES DEMO ***  `up_permissions_role_links`
--
...
--
-- SQLINES DEMO ***  `up_users_role_links`
--
...
--
-- SQLINES DEMO *** r table `admin_permissions`
--
ALTER TABLE admin_permissions
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- SQLINES DEMO *** r table `admin_permissions_role_links`
--
ALTER TABLE admin_permissions_role_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- SQLINES DEMO *** r table `admin_roles`
--
ALTER TABLE admin_roles
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- SQLINES DEMO *** r table `admin_users`
--
ALTER TABLE admin_users
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- SQLINES DEMO *** r table `admin_users_roles_links`
--
ALTER TABLE admin_users_roles_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- SQLINES DEMO *** r table `files_folder_links`
--
ALTER TABLE files_folder_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `files_related_morphs`
--
ALTER TABLE files_related_morphs
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;

--
-- SQLINES DEMO *** r table `i18n_locale`
--
ALTER TABLE i18n_locale
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE products
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- SQLINES DEMO *** r table `products_categories_links`
--
ALTER TABLE products_categories_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- SQLINES DEMO *** r table `products_sub_categories_links`
--
ALTER TABLE products_sub_categories_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- SQLINES DEMO *** r table `strapi_api_tokens`
--
ALTER TABLE strapi_api_tokens
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- SQLINES DEMO *** r table `strapi_api_token_permissions`
--
ALTER TABLE strapi_api_token_permissions
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- SQLINES DEMO *** r table `strapi_api_token_permissions_token_links`
--
ALTER TABLE strapi_api_token_permissions_token_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- SQLINES DEMO *** r table `strapi_core_store_settings`
--
ALTER TABLE strapi_core_store_settings
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- SQLINES DEMO *** r table `strapi_database_schema`
--
ALTER TABLE strapi_database_schema
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- SQLINES DEMO *** r table `strapi_migrations`
--
ALTER TABLE strapi_migrations
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `strapi_transfer_tokens`
--
ALTER TABLE strapi_transfer_tokens
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `strapi_transfer_token_permissions`
--
ALTER TABLE strapi_transfer_token_permissions
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `strapi_transfer_token_permissions_token_links`
--
ALTER TABLE strapi_transfer_token_permissions_token_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `strapi_webhooks`
--
ALTER TABLE strapi_webhooks
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `sub_categories`
--
ALTER TABLE sub_categories
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- SQLINES DEMO *** r table `sub_categories_categories_links`
--
ALTER TABLE sub_categories_categories_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- SQLINES DEMO *** r table `upload_folders`
--
ALTER TABLE upload_folders
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `upload_folders_parent_links`
--
ALTER TABLE upload_folders_parent_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `up_permissions`
--
ALTER TABLE up_permissions
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- SQLINES DEMO *** r table `up_permissions_role_links`
--
ALTER TABLE up_permissions_role_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- SQLINES DEMO *** r table `up_roles`
--
ALTER TABLE up_roles
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- SQLINES DEMO *** r table `up_users`
--
ALTER TABLE up_users
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- SQLINES DEMO *** r table `up_users_role_links`
--
ALTER TABLE up_users_role_links
  MODIFY id cast(10 as int) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- SQLINES DEMO *** able `admin_permissions`
--
ALTER TABLE admin_permissions
...
--
-- SQLINES DEMO *** able `admin_permissions_role_links`
--
ALTER TABLE admin_permissions_role_links
...
--
-- SQLINES DEMO *** able `admin_users_roles_links`
--
ALTER TABLE admin_users_roles_links
...
--
-- SQLINES DEMO *** able `files_folder_links`
--
ALTER TABLE files_folder_links
...
--
-- SQLINES DEMO *** able `files_related_morphs`
--
ALTER TABLE files_related_morphs
  ADD CONSTRAINT files_related_morphs_fk FOREIGN KEY (file_id) REFERENCES files (id) ON DELETE CASCADE;

--
-- SQLINES DEMO *** able `i18n_locale`
--
ALTER TABLE i18n_locale
...
--
-- SQLINES DEMO *** able `products_categories_links`
--
ALTER TABLE products_categories_links
...
--
-- SQLINES DEMO *** able `products_sub_categories_links`
--
ALTER TABLE products_sub_categories_links
...
--
-- SQLINES DEMO *** able `strapi_api_tokens`
--
ALTER TABLE strapi_api_tokens
...
--
-- SQLINES DEMO *** able `strapi_api_token_permissions`
--
ALTER TABLE strapi_api_token_permissions
...
--
-- SQLINES DEMO *** able `strapi_api_token_permissions_token_links`
--
ALTER TABLE strapi_api_token_permissions_token_links
...
--
-- SQLINES DEMO *** able `strapi_transfer_tokens`
--
ALTER TABLE strapi_transfer_tokens
...
--
-- SQLINES DEMO *** able `strapi_transfer_token_permissions`
--
ALTER TABLE strapi_transfer_token_permissions
...
--
-- SQLINES DEMO *** able `strapi_transfer_token_permissions_token_links`
--
ALTER TABLE strapi_transfer_token_permissions_token_links
...
--
-- SQLINES DEMO *** able `sub_categories`
--
ALTER TABLE sub_categories
...
--
-- SQLINES DEMO *** able `sub_categories_categories_links`
--
ALTER TABLE sub_categories_categories_links
...
--
-- SQLINES DEMO *** able `upload_folders`
--
ALTER TABLE upload_folders
...
--
-- SQLINES DEMO *** able `upload_folders_parent_links`
--
ALTER TABLE upload_folders_parent_links
...
--
-- SQLINES DEMO *** able `up_permissions`
--
ALTER TABLE up_permissions
...
--
-- SQLINES DEMO *** able `up_permissions_role_links`
--
ALTER TABLE up_permissions_role_links
...
--
-- SQLINES DEMO *** able `up_users_role_links`
--
ALTER TABLE up_users_role_links
